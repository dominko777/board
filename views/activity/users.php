<?php
$this->pageTitle = Yii::t('messages','Followers').'-'.Yii::t('messages','News').'&nbsp;'.Yii::t('messages','Seo keywords on Prodalike'); //anytime this view gets called
...
<div class="activity">
    ...
    <div class="pagination-more">
        ...
        <?php if ($followers->totalItemCount > $followers->pagination->pageSize): ?>
    ...
    /*<![CDATA[*/
        (function($)
        {
            ...
            var pageCount = parseInt('<?php echo (int)$followers->pagination->pageCount; ?>');
