<?php
$this->pageTitle = Yii::t('messages','Sold').'-'.Yii::t('messages','News').'&nbsp;'.Yii::t('messages','Seo keywords on Prodalike'); //anytime this view gets called
...
<div class="activity">
    ...
    <div class="pagination-more">
        ...
        <?php if ($soldAds->totalItemCount > $soldAds->pagination->pageSize): ?>
    ...
    /*<![CDATA[*/
        (function($)
        {
            ...
            var pageCount = parseInt('<?php echo (int)$soldAds->pagination->pageCount; ?>');
