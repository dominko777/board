<div class="sb_advfields" style="display: inline-block;">
    ...
    <div class="sb_advfield">
        ...
        if ($searchForm->cb) {
            ...
            $carModelsList = CHtml::listData($carModels, 'orderID', 'name');
        }
        ?>
        <?php echo CHtml::dropDownList('cm','',$carModelsList,array('prompt'=>Yii::t('messages', 'Car model'),'options' => array($searchForm->cm=>array('selected'=>true)))); ?>
    </div>
</div>
...
<div class="sb_advfields" style="display: inline-block;">
    ...
    <div class="sb_advfield">
        ...
        $vehiclePriceList = CHtml::listData($carBrands, 'orderID', 'name'); ?>
        <?php echo CHtml::dropDownList('pm','',$vehiclePriceList,array('prompt'=>Yii::t('messages', 'Price min'),'options' => array($searchForm->pm=>array('selected'=>true)))); ?>
        <?php echo CHtml::dropDownList('pma','',$vehiclePriceList,array('prompt'=>Yii::t('messages', 'Price max'),'options' => array($searchForm->pma=>array('selected'=>true)))); ?>
    </div>
</div>
