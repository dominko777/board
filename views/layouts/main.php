...
Yii::app()->clientScript->registerScriptFile("/js/angular.min.js");
?>
...
<nav class="navbar navbar-default navbar-static-top" style="background-color: #ffffff;">  
      <div class="container">
        <div class="navbar-header">
            ...
            <a href="<?php echo Yii::app()->createUrl('site/index'); ?>" class="navbar-brand" style="padding: 6px 20px 0px 3px; "><img alt="logo" src="<?php echo Yii::app()->request->baseUrl; ?>/images/static/logov4.png"/>
        ...
        <li>
            <!--<p  class="navbar-btn" style="margin-right:20px;">
                       <a rel="nofollow" class="btn  btn-default" href="<?php /* echo Yii::app()->request->baseUrl; echo "/Prodalike.apk" */?>" ><?php /*echo Yii::t('messages', 'Android Apk'); */?></a>
            </p>-->
             <p class="navbar-btn">
                       <a rel="nofollow" class="btn btn-primary" href="<?php  if(Yii::app()->user->isGuest)  echo Yii::app()->createurl('account/login'); else  echo Yii::app()->createurl('ad/new');  ?>" ><?php echo Yii::t('messages', 'Place my ad'); ?></a>
                 </p>
              </li>
        ...
        <?php endif; ?>
          ...
          <ul class="nav navbar-nav navbar-right">
           ...
           <?php } else { ?>
            ...
            <li class="dropdown">
              <a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle" href="#"> <?php echo User::model()->getUserName(); ?><span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li>
                    <a href="<?php echo Yii::app()->createurl('account/user',array('id'=>Yii::app()->user->getUrlID())); ?>"><?php echo Yii::t('messages', 'My ads'); ?></a>
                </li>
                <li><a href="<?php echo Yii::app()->createurl('account/profile'); ?>"><?php echo Yii::t('messages', 'Profile'); ?></a></li>
                <li><a href="<?php echo Yii::app()->createurl('account/logout'); ?>"><?php echo Yii::t('messages', 'Logout'); ?></a></li>
...
<!-- Yandex.Metrika counter --> <script type="text/javascript"> (function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter34022640 = new Ya.Metrika({ id:34022640, clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = "https://mc.yandex.ru/metrika/watch.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks"); </script> <noscript><div><img src="https://mc.yandex.ru/watch/34022640" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
        
<!-- I.UA counter --><a href="http://www.i.ua/" target="_blank" onclick="this.href='http://i.ua/r.php?199238';" title="Rated by I.UA">
<script type="text/javascript"><!--
iS='http'+(window.location.protocol=='https:'?'s':'')+
'://r.i.ua/s?u199238&p4&n'+Math.random();
