...
/**
 * This is the model class for table "534q_chat_archive".
 *
 * The followings are the available columns in table '534q_chat_archive':
 * @property integer $id
 ...
 */
class ChatArchive extends CActiveRecord
{
	/**
	 ...
	 * @return ChatArchive the static model class
	 */
