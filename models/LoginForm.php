...
class LoginForm extends CFormModel
{
    ...
    public function authenticate($attribute,$params)
    {
        if(!$this->hasErrors())
        {
            ...
            if($this->_identity->authenticate() == UserIdentity::ERROR_USERNAME_INVALID)
                $this->addError('messages', Yii::t('messages','Wrong email or password'));
            ...
            // Your Custom Error :)
                ...
                $this->addError('messages', Yii::t('messages','Your account is not activated yet, please check your email.'));  
        }
    }
    ...
    public function login()
    {
        ...
        {
            $duration=$this->rememberMe ? 3600*24*31 : 0; // 30 days
