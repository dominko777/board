...
{
	/**
	 * Which implemenation of the class should be used by main
	 * 
	 ...
	 *  - Loading plugins
	 *  - Validating the main implemenation
	 *  - Returning the desired main implementation if possible
	 *  - Returning the GD implemenation if the main isn't available
	...
	public static function create ($filename = null, $options = array(), $isDataStream = false)
	{
		...
		// attempt to load the main implementation
		...
		// load the gd implementation if main failed
