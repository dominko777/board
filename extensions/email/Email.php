...
class Email extends CApplicationComponent {
	...
	/**
	 * @var string Receiver, or receivers of the chat.
	 */
	public $to = null;
	...
	/**
	 * @var string Delivery type.  If set to 'php' it will use php's chat() function, and if set to 'debug'
	...
	/**
	 * @var string The views to use as the content of the email, as an alternative to setting $this->message.
	 * Must be located in application.views.email directory.  This email object is availiable within the views
	 * through $email, thus letting you define things such as the subject within the views (helps maintain
	 * seperation of logic and output).
	 */
	public $view = null;
	
	/**
	 * @var array Variable to be sent to the views.
	 */
	public $viewVars = null;	
	
	/**
	 * @var string The layout for the views to be imbedded in. Must be located in
	 * application.views.email.layouts directory.  Not required even if you are using a views
	 */
	public $layout = null;
	...
	/**
	 * Sends email.
	 * @param mixed the content of the email, or variables to be sent to the views.
